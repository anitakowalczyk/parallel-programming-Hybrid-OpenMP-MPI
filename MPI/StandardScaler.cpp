...
double StandardScaler::calculateStandardDeviation(std::vector<dataSet *> *mnistData, int col, int rows, double mean) {
...
double StandardScaler::calculateMean(std::vector<dataSet *> *mnistData, int col, int rows) {
    double mean = 0;
    for (int row = 0; row < rows; row++) {
